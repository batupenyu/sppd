        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold">Surat Penunjukan Mewakili</h1>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <a href="{{ route('surat-mewakili.edit', $item) }}" class="text-yellow-600 hover:text-yellow-800" title="Edit" aria-label="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        ...
                                        <form action="{{ route('surat-mewakili.destroy', $item) }}" method="POST" class="inline" onsubmit="return confirm('Hapus Surat Penunjukan Mewakili ini?')">
                                            @csrf
                                            @method('DELETE')
                ...
                <div class="mt-4">
                    <a href="{{ route('surat-mewakili.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        Buat Surat Penunjukan Mewakili Baru
                    </a>
                </div>
