...
<head>
    ...
    <style>
        ...
        .content-section { font-size: 14px; text-align: justify; margin-bottom: 15px; }
        .data-table { width: 100%; margin-top: 10px; margin-bottom: 15px; font-size: 14px; border-collapse: collapse; }
        ...
        .provisions-list { margin-top: 5px; margin-bottom: 15px; padding-left: 20px; }
        .provisions-list li { font-size: 14px; text-align: justify; margin-bottom: 5px; list-style-type: none; position: relative; }
        .provisions-list li::before { content: attr(data-number) ". "; position: absolute; left: -20px; }
        .signature-section { width: 100%; margin-top: 40px; font-size: 14px; }
        .signature-table { float: right; width: 300px; text-align: left; }
        .signature-space { height: 80px; }
        .tembusan { margin-top: 60px; font-size: 12px; clear: both; }
