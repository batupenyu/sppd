    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <h1 class="text-2xl font-bold mb-6">Edit Surat Tugas</h1>

                <form action="{{ route('surat-tugas.update', $suratTugas) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nomor" value="{{ old('nomor', $suratTugas->nomor) }}" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block font-medium mb-1">Dasar (satu item per baris)</label>
                            <textarea name="dasar" rows="4" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">{{ old('dasar', $suratTugas->dasar) }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text" name="dikeluarkan_di" value="{{ old('dikeluarkan_di', $suratTugas->dikeluarkan_di) }}" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                        </div>
                        <div>
                            ...
                            <select id="penandatangan_select" name="penandatangan_id" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                                ...
                                @foreach($asns as $asn)
                                    <option value="{{ $asn->id }}"
                                        ...
                                        data-nip="{{ $asn->nip ?: '' }}"
                                        {{ old('penandatangan_id', $suratTugas->penandatangan_id ?? $defaultPenandatanganId) == $asn->id ? 'selected' : '' }}>
