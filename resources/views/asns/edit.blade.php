                    ...
                    <div id="tab-kepegawaian" class="tab-content hidden">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="unit_kerja" value="{{ old('unit_kerja', $asn->unit_kerja ?? 'SMK Negeri 1 Koba') }}" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="nama_opd_indu" rows="2" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">{{ old('nama_opd_indu', $asn->nama_opd_indu) }}</textarea>
