    ...
    <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <h1 class="text-2xl font-bold mb-6">Buat Form Cuti</h1>

                <form action="{{ route('form-cutis.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nomor_surat" value="{{ old('nomor_surat','800.1.11.4 / ................ / 2026') }}" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="jenis_cuti" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                                ...
                                <option value="Cuti Tahunan" {{ old('jenis_cuti') == 'Cuti Tahunan' ? 'selected' : '' }}>1. Cuti Tahunan</option>
                                <option value="Cuti Besar" {{ old('jenis_cuti') == 'Cuti Besar' ? 'selected' : '' }}>2. Cuti Besar</option>
                                <option value="Cuti Sakit" {{ old('jenis_cuti') == 'Cuti Sakit' ? 'selected' : '' }}>3. Cuti Sakit</option>
                                <option value="Cuti Melahirkan" {{ old('jenis_cuti') == 'Cuti Melahirkan' ? 'selected' : '' }}>4. Cuti Melahirkan</option>
                                <option value="Cuti Karena Alasan Penting" {{ old('jenis_cuti') == 'Cuti Karena Alasan Penting' ? 'selected' : '' }}>5. Cuti Karena Alasan Penting</option>
                                <option value="Cuti di Luar Tanggungan Negara" {{ old('jenis_cuti') == 'Cuti di Luar Tanggungan Negara' ? 'selected' : '' }}>6. Cuti di Luar Tanggungan Negara</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_mulai_cuti" value="{{ old('tanggal_mulai_cuti') }}" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                        </div>
                        <div>
                            <label class="block font-medium mb-1">Sampai Tanggal</label>
                            <input type="date" name="tanggal_selesai_cuti" value="{{ old('tanggal_selesai_cuti') }}" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat_cuti" rows="2" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">{{ old('alamat_cuti') }}</textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="kepala_sekolah_id" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                                ...
                                @foreach($asns as $asn)
                                    <option value="{{ $asn->id }}" {{ old('kepala_sekolah_id') == $asn->id ? 'selected' : '' }}>
                                        {{ $asn->nama }} {{ $asn->nip ? '(' . $asn->nip . ')' : '' }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="kepala_cabang_id" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                                ...
                                @foreach($asns as $asn)
                                    <option value="{{ $asn->id }}" {{ old('kepala_cabang_id') == $asn->id ? 'selected' : '' }}>
                                        {{ $asn->nama }} {{ $asn->nip ? '(' . $asn->nip . ')' : '' }}
                                    </option>
                                @endforeach
                            </select>
