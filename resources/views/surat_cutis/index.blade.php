        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold">Surat Cuti</h1>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full table-auto">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <a href="{{ route('surat-cutis.edit', $suratCuti) }}" class="text-yellow-600 hover:text-yellow-800" title="Edit" aria-label="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        ...
                                        <form action="{{ route('surat-cutis.destroy', $suratCuti) }}" method="POST" class="inline" onsubmit="return confirm('Hapus Surat Cuti ini?')">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="px-4 py-2 text-center">Belum ada data Surat Cuti.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="mt-4">
                    <a href="{{ route('surat-cutis.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
