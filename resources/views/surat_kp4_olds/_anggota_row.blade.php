...
<tr class="anggota-row border-t">
    ...
    <td class="px-2 py-2">
        <input type="text" name="anggota[{{ $i }}][penghasilan_sebulan]" value="{{ old('anggota.' . $i . '.penghasilan_sebulan', $a['penghasilan_sebulan'] ?? '') }}" class="w-full border rounded px-2 py-1 dark:bg-gray-700 dark:text-gray-100" placeholder="Rp -">
    </td>
    <td class="px-2 py-2">
        <input type="text" name="anggota[{{ $i }}][keterangan]" value="{{ old('anggota.' . $i . '.keterangan', $a['keterangan'] ?? '') }}" class="w-full border rounded px-2 py-1 dark:bg-gray-700 dark:text-gray-100" placeholder="Suami/Istri/Tanggungan">
    </td>
