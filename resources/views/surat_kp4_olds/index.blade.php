        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold">Surat KP4 Lama</h1>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    <div class="flex items-center gap-3">
                                        <a href="{{ route('surat-kp4-olds.print', $suratKp4Old) }}" class="text-blue-600 hover:text-blue-800" title="Cetak" aria-label="Cetak">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M6 9V2h12v7M6 18H4a2 2 0 01-2-2v-5a2 2 0 012-2h16a2 2 0 012 2v5a2 2 0 01-2 2h-2M6 14h12v8H6v-8z"/>
                                            </svg>
                                        </a>
                                        <a href="{{ route('surat-kp4-olds.edit', $suratKp4Old) }}" class="text-yellow-600 hover:text-yellow-800" title="Edit" aria-label="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        ...
                                        <form action="{{ route('surat-kp4-olds.destroy', $suratKp4Old) }}" method="POST" class="inline" onsubmit="return confirm('Hapus Surat KP4 Lama ini?')">
                                            @csrf
                                            @method('DELETE')
                ...
                <div class="mt-4">
                    <a href="{{ route('surat-kp4-olds.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        Buat Surat KP4 Lama Baru
                    </a>
                </div>
