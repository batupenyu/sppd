    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <h1 class="text-2xl font-bold mb-6">Buat Lampiran</h1>
                ...
                <form action="{{ route('lampirans.store') }}" method="POST">
                    @csrf

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            <label class="block font-medium mb-1">Judul Lampiran</label>
                            <input type="text" name="judul" value="{{ old('judul', 'Lampiran') }}" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100" placeholder="Contoh: Lampiran I">
                        </div>

                        <div class="md:col-span-2">
                            <label class="block font-medium mb-1">Nomor</label>
                            <input type="text" name="nomor" value="{{ old('nomor','800.1.11.1/..../SMKN 1 Kb/Dindik/2026') }}" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100" placeholder="Contoh: 800.1.11.1/..../SMKN 1 Kb/Dindik/2026">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="keterangan" rows="3" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">{{ old('keterangan','Surat Kepala SMK Negeri 1 Koba') }}</textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select id="penandatangan_select" name="penandatangan_id" class="w-full border rounded px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                                ...
                                @foreach($asns as $asn)
                                    <option value="{{ $asn->id }}" {{ old('penandatangan_id', $defaultPenandatanganId) == $asn->id ? 'selected' : '' }}>
